    ...
    public static IEnumerable<object?[]> GetEntityGetInputTestData()
        ...
        new[]
        {
            new object?[]
            {
                ...
                "https://some.crm4.dynamics.com/api/data/v9.2/SomeEntities(SomeKey)?$select=field1,field2",
                null
            },
            new object?[]
            {
                ...
                "https://some.crm4.dynamics.com/api/data/v9.2/SomeEntities(SomeKey)?$select=field 1",
            ...
            new object?[]
            {
                ...
                "http://ggroupp.ru/api/data/v9.2/Some%2fEntities(Some=Key)",
