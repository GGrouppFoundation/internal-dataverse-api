...
partial class ApiClientTestDataSource
{
    public static IEnumerable<object[]> GetEntityCreateInputTestData()
    {
        ...
        yield return new object[]
        {
            ...
            "https://some.crm4.dynamics.com/api/data/v9.0/SomeEntities?$select=field1,field2",
        ...
        yield return new object[]
        {
            ...
            "https://some.crm4.dynamics.com/api/data/v9.0/SomeEntities?$select=field 1",
        ...
        yield return new object[]
        {
            ...
            new DataverseEntityCreateIn<StubRequestJson>(
                ...
                entityData: emptyRequest),
            "http://ggroupp.ru/api/data/v9.0/Some%2fEntities",
            Serialize(emptyRequest)
        };
    }
}