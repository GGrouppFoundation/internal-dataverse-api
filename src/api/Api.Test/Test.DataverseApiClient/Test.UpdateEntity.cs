...
partial class DataverseApiClientTest
{
    ...
    public async Task UpdateEntityAsync_ResponseIsUnauthorized_ExpectUnauthorizedFailure(
        StringContent? responseContent, string failureMessage)
    {
        ...
        var actual = await dataverseApiClient.UpdateEntityAsync<StubRequestJson, StubResponseJson>(SomeDataverseEntityUpdateInput, CancellationToken.None);
